...
[<assembly: AssemblyTitleAttribute("FSharpWebCrawler")>]
[<assembly: AssemblyProductAttribute("FSharpWebCrawler")>]
...
module internal AssemblyVersionInformation =
    let [<Literal>] AssemblyTitle = "FSharpWebCrawler"
    let [<Literal>] AssemblyProduct = "FSharpWebCrawler"
