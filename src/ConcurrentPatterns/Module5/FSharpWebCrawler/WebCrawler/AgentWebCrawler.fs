...
module WebCrawler =
    ...
    open FSharpWebCrawler.MessagePassing.AgentPipeline
    ...
    module ParallelWebCrawler =
        ...
        module PrintAgentTest =
            ...
            let print = printerAgent CancellationToken.None
            print.Post (Item "Hello from printerAgent!!")
    ...
    //     If already completed the "Agent Pipeline" lab, then feel free to use the "parallelAgent" already created
        ...
        let imageParserAgent () =
            //let httpRgxLocal = new ThreadLocal<_>(fun () -> ... )
            parallelAgent parallelism (fun inbox ->
