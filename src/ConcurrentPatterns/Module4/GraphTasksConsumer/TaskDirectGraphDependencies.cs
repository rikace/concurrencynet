...
namespace GraphTasksConsumer
{
    ...
    // (3) Bonus implement these options
    //     a. Use Memoization to avoid processing the same input twice
    //     b. For operations with no dependencies,
    ...
    //     c. You may want operations to be able to return data that is passed along to dependencies, hence building up large dataflow networks.
    ...
    public class TaskDirectGraphDependencies : ITaskDirectGraphDependencies
    {
        ...
        //
        // TODO update the signature to handle async operations (in place of the Action operation)
