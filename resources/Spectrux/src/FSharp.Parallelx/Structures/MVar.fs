namespace FSharp.Parallelx.Structures
...
module MVar =
    ...
    //    awaitTaskCancellationAsError t    
      ...
      /// Creates an async computation which returns the value contained in an IVar.
      let getWithTimeout (timeout:TimeSpan) (timeoutResult:unit -> 'a) (i:IVar<'a>) : Async<'a> = async {
    ...
    //    __.UpdateStateAsync (update >> Async.map)
