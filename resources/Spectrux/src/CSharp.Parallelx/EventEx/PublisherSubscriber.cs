...
namespace CSharp.Parallelx.EventEx
{
    ...
    {
        IDisposable Subscribe<TMessage>(Action<TMessage> handle);
    ...
    public sealed class SubscriptionService : ISubscriptionService
    {
        ...
        //     return new Unsubscribe(resource, _publisherSubscriptions);
        // }
        public IDisposable Subscribe<TMessage>(Action<TMessage> handle)
        {
            if (handle == null) throw new ArgumentNullException("handle");

            var resource =
                _subject.AsObservable().OfType<TMessage>()
                    .Subscribe(handle);
        ...
        private class Unsubscribe : IDisposable
        {
            ...
            public Unsubscribe(IDisposable resource, List<IDisposable> subscriptions)
            {
