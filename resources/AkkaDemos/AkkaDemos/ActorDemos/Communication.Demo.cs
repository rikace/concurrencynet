    ...
    public class Communication
{
    ...
    public static void Start()
    {
        ...
        var  cwActor = system.ActorOf(Props.Create<ConsoleWriterActor>(), "cw-actor");

        fbActor = system.ActorOf(Props.Create(() => new FizzBuzzActor()), "fb-actor");


        for (var i = 1; i <= 10000; i++)
        {
            fbActor.Tell(new FizzBuzzMessage(i), cwActor);
        }
